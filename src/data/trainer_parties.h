...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    .species = SPECIES_GLAMEOW,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_SLAM, MOVE_TAIL_WHIP, MOVE_ENCORE, MOVE_SING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_RETURN, MOVE_KNOCK_OFF, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_CURSE, MOVE_ROCK_THROW, MOVE_TAUNT}
    },
    {
    .iv = 150,
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ANCIENT_POWER, MOVE_WING_ATTACK, MOVE_KNOCK_OFF, MOVE_LEER}
    },
    {
    .iv = 150,
    .lvl = 13,
    .species = SPECIES_ARON,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_METAL_CLAW, MOVE_ROCK_THROW, MOVE_HARDEN}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_RECOVER, MOVE_MEGA_DRAIN, MOVE_CONFUSE_RAY}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .moves = {MOVE_COUNTER, MOVE_POISON_STING, MOVE_FAKE_OUT, MOVE_U_TURN}
    },
    {
    .iv = 150,
    .lvl = 18,
    ...
    .heldItem = ITEM_LEEK,
    .moves = {MOVE_PECK, MOVE_ROCK_SMASH, MOVE_SAND_ATTACK, MOVE_SIMPLE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 18,
    ...
    .moves = {MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_LEECH_SEED, MOVE_SEED_BOMB}
    },
    {
    .iv = 60,
    .lvl = 20,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_DRAINING_KISS, MOVE_PSYBEAM, MOVE_CALM_MIND}
    },
    {
    .iv = 230,
    .lvl = 20,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_POLISH, MOVE_STEALTH_ROCK, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 200,
    .lvl = 22,
    ...
    .moves = {MOVE_ENCORE, MOVE_SURF, MOVE_THUNDERBOLT, MOVE_NUZZLE}
    },
    {
    .iv = 220,
    .lvl = 24,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_OVERHEAT, MOVE_THUNDER_WAVE, MOVE_HEX}
    },
    {
    .iv = 200,
    .lvl = 25,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CHARGE_BEAM, MOVE_TOXIC, MOVE_CRUNCH, MOVE_SWAGGER}
    },
    {
    .iv = 200,
    .lvl = 26,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_ACROBATICS, MOVE_ROOST, MOVE_SUBSTITUTE}
    },
    {
    .iv = 250,
    .lvl = 27,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COIL, MOVE_INFERNO, MOVE_BUG_BITE, MOVE_WILL_O_WISP}
    },
    {
    .iv = 200,
    .lvl = 28,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WEATHER_BALL, MOVE_LUCKY_CHANT, MOVE_HEAT_WAVE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 250,
    .lvl = 30,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_FIRE_FANG, MOVE_ICICLE_CRASH, MOVE_BRICK_BREAK, MOVE_WORK_UP}
    },
    {
    .iv = 250,
    .lvl = 30,
    ...
    .moves = {MOVE_ENCORE, MOVE_VENOSHOCK, MOVE_TOXIC, MOVE_FIRE_LASH}
    },
    {
    .iv = 250,
    .lvl = 32,
    ...
    .moves = {MOVE_ERUPTION, MOVE_EARTHQUAKE, MOVE_YAWN, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 32,
    ...
    .moves = {MOVE_PROTECT, MOVE_ANCIENT_POWER, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_SNORE, MOVE_REST, MOVE_BODY_SLAM, MOVE_BELCH}
    },
    {
    .iv = 200,
    .lvl = 32,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HAMMER_ARM, MOVE_ATTRACT, MOVE_BIND, MOVE_BRUTAL_SWING}
    },
    {
    .iv = 200,
    .lvl = 34,
    ...
    .moves = {MOVE_BOUNCE, MOVE_BULLDOZE, MOVE_SCORCHING_SANDS, MOVE_PROTECT}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .moves = {MOVE_CROSS_CHOP, MOVE_NIGHT_SLASH, MOVE_HEADBUTT, MOVE_OBSTRUCT}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .moves = {MOVE_FACADE, MOVE_ROOST, MOVE_BRAVE_BIRD, MOVE_FOCUS_ENERGY}
    },
    {
    .iv = 250,
    .lvl = 36,
...
static const struct TrainerMonNoItemCustomMoves sParty_GinaAndMia2[] = {
    ...
    .lvl = 10,
    .species = SPECIES_DEWPIDER,
    .moves = {MOVE_X_SCISSOR, MOVE_PROTECT, MOVE_SWORDS_DANCE, MOVE_LIQUIDATION}
    },
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_FOONGUS,
    .moves = {MOVE_ABSORB, MOVE_LEECH_SEED, MOVE_ENCORE, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MayRoute103Treecko[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .moves = {MOVE_THUNDER, MOVE_PROTECT, MOVE_CALM_MIND, MOVE_DRAGON_PULSE}
    },
    {
    .iv = 255,
    .lvl = 46,
