const struct Trainer gTrainers[] = {
    ...
    [TRAINER_GRUNT_PETALBURG_WOODS] =
    {
        ...
        .party = {.ItemDefaultMoves = sParty_GruntPetalburgWoods},
    },
    ...
    [TRAINER_ROXANNE_1] =
    {
        ...
        .items = {ITEM_POTION, ITEM_POTION, ITEM_FULL_HEAL, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
    ...
    [TRAINER_FLANNERY_1] =
    {
        ...
        .items = {ITEM_HYPER_POTION, ITEM_HYPER_POTION, ITEM_MEGA_RING, ITEM_NONE},
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
